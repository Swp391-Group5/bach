                                ...
                                <div class="product_description">
                                    ...
                                    <div> <span class="product_price"> <h3 style="color: red"> Price: <fmt:formatNumber value="${detail.productPrice}" type="number" maxFractionDigits="2"/> <span>&#8363;</span> </h3></span> </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="product_quantity"> <span>QTY: </span> <input id="quantity_input" type="text" pattern="[0-9]*" value="${detail.productQuantity}">
                                    ...
                                    <div class="modal-content">
                                        <form action="feed-back" method="post">
                                            ...
                                            <div class="modal-body text-center">
                                                <img src="${detail.getProductImage()}" alt="Product Image" class="img-fluid">
                                                <h5 class="mt-2">${detail.productName}</h5>
                                                 Star Rating Input 
                                                <div class="star-rating">
                                                    <input type="radio" id="5-stars" name="StarRate" value="5" onchange="updateEmoji(this)" />
                                                    <label for="5-stars" class="star">&#9733;</label>
                                                    <input type="radio" id="4-stars" name="StarRate" value="4" onchange="updateEmoji(this)" />
                                                    <label for="4-stars" class="star">&#9733;</label>
                                                    <input type="radio" id="3-stars" name="StarRate" value="3" onchange="updateEmoji(this)" />
                                                    <label for="3-stars" class="star">&#9733;</label>
                                                    <input type="radio" id="2-stars" name="StarRate" value="2" onchange="updateEmoji(this)" />
                                                    <label for="2-stars" class="star">&#9733;</label>
                                                    <input type="radio" id="1-star" name="StarRate" value="1" onchange="updateEmoji(this)" />
                                                    <label for="1-star" class="star">&#9733;</label>
                                                </div>
                                                <div id="emojiContainer"></div>
                                                <textarea class="form-control" id="feedbackText" placeholder="Share your thoughts about the product..." rows="3"></textarea>
                                                                                <input type="text" class="form-control mt-2" id="fullName" placeholder="Enter your full name">
                                                                                <input type="text" class="form-control mt-2" id="phoneNumber" placeholder="Enter your phone number">
                                                                                <input type="email" class="form-control mt-2" id="email" placeholder="Enter your email (for feedback notifications)">
                                                <input type="file" class="form-control-file mt-2" id="feedbackImage">
                                            </div>
